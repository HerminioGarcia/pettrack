...
class FormDatosPersonales(forms.ModelForm):
    ...
    class Meta:
        ...
        # Campos excluidos de la generación automática de campos del formulario
        exclude = ['user']
        # Puedes usar '__all__' para incluir todos los campos, excepto los excluidos
        fields = '__all__'
        widgets = {
