...
urlpatterns = [
    ...
    path('Encargado', login_required(
        views.CrearPerfilView.as_view()), name='perfil'),
    path('EncargadoEditar', login_required(
        views.EditarPerfilView.as_view()), name='perfilEditar'),
    ...
    path('restablecer_contrasena/',
         CustomPasswordResetView.as_view(), name='password_reset1'),
    path('restablecer-contrasena/hecho/', auth_views.PasswordResetDoneView.as_view(
