Característica: Registro de usuario
  ...
  Dado que ingreso al enlace "http://localhost:8000/entrar?next=/"
  ...
  Y al estar en la ventana de correo verificado ingreso mi usuario "Pruebas" y mi contraseña "testing1234"
  Entonces puedo ver la ventana de localización de mascotas